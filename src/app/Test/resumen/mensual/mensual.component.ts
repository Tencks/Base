...
export class MensualComponent {
  ...
  { id: 1, producto: 'PAN', precio: 1000.00, fecha: '02/02/24' },
  { id: 2, producto: 'BIZCOCHITOS', precio: 2500.00, fecha: '16/02/24' },
  { id: 3, producto: 'FACTURAS', precio: 360.00, fecha: '28/02/24' }
];
